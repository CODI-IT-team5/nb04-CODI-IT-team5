...
-- AddForeignKey
ALTER TABLE "public"."PoductDiscount" ADD CONSTRAINT "PoductDiscount_productId_fkey" FOREIGN KEY ("productId") REFERENCES "public"."Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
